// pages/user/purchase_record/purchase_record.js
...
Page({
  ...
  onConfirm(e){
	...
	var dateArr = [this.formatDate(start),this.formatDate(end)];
    this.setData({
      date:dateArr,
      show:false
    })
  ...
  skip(event) {
    ...
    wx.navigateTo({
      url: '../purchase_detail/purchase_detail?id=' + JSON.stringify(obj),
    })
  },
  /**
   * 账单列表
